/*******************************
* File Name: CoursePage.jsx   *
* Author: Ammar S.A.A          *
* Output: Course Order Page   *
*******************************/
  ...
  return (
    <div className="container-fluid">
      <div className="text-center">
        <h1 className="mt-5 mb-3">{course.title}</h1>
      </div>
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-6 col-md-8 col-sm-10 mx-auto p-4">
            <div>
              <p className="color-secondary"><b>Description</b>: {course.description}</p>
              <p>
                <b>Price:</b> $<del>{course.price}</del> - <ins>{course.discountPercentage}</ins>
              </p>
              <div className="d-flex align-items-center mb-2">
                <StarRatings
                  ...
                  starSpacing="2px"
                />
                <span className="ms-2 mt-2">{course.rating}</span>
              </div>
              <p><b>Stock Left:</b> {course.stock}</p>
