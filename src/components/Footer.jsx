  ...
  return (
    <footer className="bg-dark text-light py-4" style={{ position: 'relative', bottom: 0, top: '25vh', width: '100%' }}>
      <div className="container">
                  ...
                  <ul className="list-unstyled">
                    {column.map((category) => (
                      <li key={category} className='my-3 category'>
                        <a href={`courses/category/${category}`} className="text-light">{category.toUpperCase()}</a>
                      </li>
                    ))}
                  </ul>
                </div>
        ...
        <hr />
        <div className="row">
          <div className="col-md-6 text-start">&copy; 2023 Learners. All rights reserved.</div>
